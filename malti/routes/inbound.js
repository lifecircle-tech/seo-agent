...
import { handleWhatsAppAgentMessage }        from "../controllers/whatsappAgentController.js";
...
router.post("/whatsapp-agent", handleWhatsAppAgentMessage);  // AI agent for existing customers & CGs
